...
package np.com.hemnath.mylens.mlkit.objectdetector
...
import np.com.hemnath.mylens.mlkit.GraphicOverlay
import np.com.hemnath.mylens.mlkit.VisionImageProcessor
import np.com.hemnath.mylens.mlkit.VisionProcessorBase
import java.io.IOException

/** A processor to run object detector.  */
class ObjectDetectorProcessor(context: Context, options: ObjectDetectorOptionsBase) :
  VisionProcessorBase<List<DetectedObject>>(context), VisionImageProcessor {
